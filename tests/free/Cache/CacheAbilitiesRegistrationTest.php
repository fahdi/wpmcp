...
class CacheAbilitiesRegistrationTest extends \WP_UnitTestCase
{
    private const NAMES = [
    ...
    public function test_cache_tools_are_registered_as_free_abilities(): void
    {
    ...
    public function test_cache_abilities_have_description_and_category(): void
    {
    ...
    public function test_cache_abilities_deny_subscriber_and_allow_administrator(): void
    {
        $abilities = wp_get_abilities();
